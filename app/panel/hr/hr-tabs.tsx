...
export type HrTabKey = "genel-bakis" | "personel" | "prim" | "gizlilik" | "hareketler";
...
export function HrTabs({ active, access }: { active: HrTabKey; access: HrAccess }) {
  const tabs: { key: HrTabKey; href: string; label: string }[] = [
    ...
    ...(canSeeCommissions(access) ? [{ key: "prim" as const, href: "/panel/hr/commissions", label: "Prim Hesaplama" }] : []),
