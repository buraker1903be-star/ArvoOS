...
type Contract={id:string;contract_no:string;title:string;scope:string|null;amount:number;currency:string;payment_plan:string|null;start_date:string|null;due_date:string|null;status:string;sent_at:string|null;first_viewed_at:string|null;last_viewed_at:string|null;view_count:number;signed_name:string|null;signed_at:string|null;workflow_id:string|null;created_at:string;crm_opportunities:{customer_name:string;contact_email:string|null;contact_phone:string|null;title:string}|null};
...
export default async function ContractsPage({searchParams}:Props){
 ...
 let q=supabase.from("crm_contracts").select("id,contract_no,title,scope,amount,currency,payment_plan,start_date,due_date,status,sent_at,first_viewed_at,last_viewed_at,view_count,signed_name,signed_at,workflow_id,created_at,crm_opportunities!inner(customer_name,contact_email,contact_phone,title)").eq("organization_id",membership.organization_id);
