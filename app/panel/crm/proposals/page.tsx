...
export default async function ProposalsPage() {
  ...
  return <div className="crm-page-stack">
    <div className="panel-pagehead">
      <div><small className="panel-kicker">CRM / TEKLİFLER</small><h1>Teklifler</h1><p>Hazırlanan, onay bekleyen ve onaylanan teklifleri yönetin.</p></div>
      <div className="panel-page-actions"><span className="status-pill">{rows.length} teklif</span><Link className="panel-primary" href="/panel/crm">Taleplere git</Link></div>
    </div>
