...
export default async function InvoicesPage(){
 ...
 return <div className="finance-page-stack">
  <div className="panel-pagehead"><div><small className="panel-kicker">FİNANS / FATURALAR</small><h1>Faturalar</h1><p>Sözleşmelerden oluşan fatura taslaklarını kontrol edin, açın ve tahsilat durumunu yönetin.</p></div><div className="panel-page-actions"><span className="status-pill">{rows.length} fatura</span><Link className="panel-secondary" href="/panel/finance">Finans merkezi</Link><Link className="panel-primary" href="/panel/finance/payment-plans">Ödeme planları</Link></div></div>
