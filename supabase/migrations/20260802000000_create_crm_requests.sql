...
drop policy if exists "members_can_read_organization_crm_requests" on public.crm_requests;
...
drop policy if exists "members_can_create_organization_crm_requests" on public.crm_requests;
...
drop policy if exists "members_can_update_organization_crm_requests" on public.crm_requests;
...
drop policy if exists "managers_can_delete_organization_crm_requests" on public.crm_requests;
