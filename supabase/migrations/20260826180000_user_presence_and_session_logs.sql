...
create index if not exists user_presence_online_idx on public.user_presence (organization_id,last_seen_at desc);
create index if not exists user_session_logs_org_login_idx on public.user_session_logs (organization_id,login_at desc);
create index if not exists user_session_logs_user_open_idx on public.user_session_logs (user_id,logout_at,last_seen_at desc);
...
drop policy if exists "session_logs_select_own_or_manager" on public.user_session_logs;
drop policy if exists "session_logs_insert_own" on public.user_session_logs;
drop policy if exists "session_logs_update_own" on public.user_session_logs;
